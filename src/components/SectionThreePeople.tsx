...
const SectionThreePeople = () => {
    ...
    return (
        <div className='fix-row3 container-fluid main1' style={{ backgroundColor: 'rgb(242 242 242 / 7%) ', minHeight: '600px', display: 'flex', justifyContent: 'center', width: '100%', paddingRight: '12%', paddingLeft: '12%', paddingTop: '0px', paddingBottom: '120px' }}>
