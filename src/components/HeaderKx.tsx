...
<Link to={'/comisiones'} ><Typography className='menuItem3'  style={{ fontWeight: 'bold',  fontSize: '17px' }}>Comisiones</Typography></Link>
*/
    return (
        <PageHeader
            className="site-page-header"
            style={{ backgroundColor: 'transparent', color:'white', position: 'fixed', top: 0, right: 0, left: 0, zIndex: '100000' }}
            extra={[]}
            ...
            <Content style={{ display: 'flex', paddingTop: 0 }}>
                <Drawer zIndex={100000} open={nav} onClose={() => { setnav(!nav) }}>
                    <Content className='content-nav2'>
                        ...
                        <Link to={'/cuentaEmpresa/#top'}><Typography className='menuItem3' style={{ fontWeight: 'bold', padding: '10px', fontSize: '17px' }}>Empresas</Typography></Link>
                        ...
                        <a href='https://exchange.kiiex.io/login'><Typography className='menuItem3' style={{ fontWeight: 'bold', padding: '10px', fontSize: '17px' }}>Iniciar Sesion</Typography></a>
                        <a href='https://exchange.kiiex.io/signup'><Button  onMouseLeave={()=>{setTextBtn('Registro')}} className='boton-register2' style={{ fontSize: '17px', height: '40px', marginTop: '3px' }}>{textBtn}</Button></a>
                    </Content>
                </Drawer>
                <Content>
                ...
                <Content className='nav-bar' style={{ display: nav ? 'none' : 'none' }}>
                    <Content className='content-nav'>
                        <div className="itemsMenu">
                            ...
                            <Link  to={'/cuentaEmpresa'}><Typography className='menuItem3' style={{ fontWeight: 'bold',  fontSize: '17px' }}>Empresas</Typography></Link>
                        ...
                        <div style={{ display: 'flex', paddingTop:'5px' }}>
                            <a href='https://exchange.kiiex.io/login'><Typography className='menuItem3' style={{ fontWeight: 'bold',  fontSize: '17px', paddingTop:'10px' }}>Iniciar Sesion</Typography></a>
                            <a href='https://exchange.kiiex.io/signup'><Button onMouseLeave={()=>{setTextBtn('Registro')}} className='boton-one-header' style={{ fontSize: '14px', height: '40px', marginTop: '3px' }}>{textBtn}</Button></a>
                        </div>
