...
const SectionThreeCompany = () => {
    ...
    const CARDS: IPropsCards[] = [{
        ...
        icon: <LowComision color='#22335e' width='100px' heigth='100px' />
    },
    {
        ...
        icon: <CustomPedido color='#22335e' width='100px' heigth='100px' />
    },
    {
        title: 'Soporte 24/7',
        description: 'Una persona siempre estará resolviendo tus dudas, no una máquina.',
        icon: <ClientService24 color='#22335e' width='100px' heigth='100px' />
    },
    {
        ...
        icon: <ClientVerify color='#22335e' width='100px' heigth='100px' />
    }
