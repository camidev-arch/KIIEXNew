                ...
                <Content className='nav-bar' style={{paddingRight:'5.6%', display:'none'}}>
                    <Content className='content-nav'>
                        <div className="itemsMenu">
                            ...
                            <Link to={'/cuentaEmpresa'}><Typography className='menuItem2Active' style={{ fontWeight: 'bold', fontSize: '17px' }}>Empresas</Typography></Link>
                        ...
                        <div style={{ display: 'flex' }}>
                            <a href='https://exchange.kiiex.io/login'><Typography className='menuItem2' style={{ fontWeight: 'bold', fontSize: '17px', paddingTop: '10px' }}>Iniciar Sesion</Typography></a>
                            <a href='https://exchange.kiiex.io/signup'><Button onMouseLeave={()=>{setTextBtn('Registro')}} className='boton-register2' style={{ fontSize: '15px', height: '40px', marginTop: '3px' }}>{textBtn}</Button></a>
                        </div></Content>
