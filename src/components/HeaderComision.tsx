            ...
            <Content style={{ display: 'flex', paddingTop: 0 }}>
                <Drawer zIndex={100000} open={nav} onClose={() => { setnav(!nav) }} >
                    <Content className='content-nav2'>
                        ...
                        <a href='https://exchange.kiiex.io/signup'><Typography className='menuItem3' style={{ fontWeight: 'bold', padding: '10px', fontSize: '17px' }}>Iniciar Sesion</Typography></a>
                        <a href='https://exchange.kiiex.io/login'><Button  onMouseLeave={()=>{setTextBtn('Registro')}} className='boton-register2' style={{ fontSize: '17px', height: '40px', marginTop: '3px' }}>{textBtn}</Button></a>
                    </Content>
                </Drawer>
                <Content>
