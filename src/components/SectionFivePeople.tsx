    ...
    <div className='container-fluid sectionFivePeople' >
      <div className='row' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
        <div className='col-12' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }} >
          <h1 className='aprovecha-title' style={{ marginTop: 0, textAlign: 'center', fontWeight:'bold' }}>Aprovecha al máximo las posibilidades que tienes con KIIEX</h1>
          <p className='text-center p-one main-p2f' style={{ fontSize: '30px', color: '#2C133D', fontWeight:'lighter' }}>
          ...
          <Row style={{ width: '100%' }}>
            ...
            <a href='https://ui.kiire.apstage.net/signup'><Button className='boton-one3' style={{maxWidth:'300px'}} >Inscríbete para comenzar</Button></a>
            </Col>
          </Row>
        </div>
      </div>
