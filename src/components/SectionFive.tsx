          ...
          <ol style={{ listStyle: 'none',  marginTop: '16%' }}>
            ...
            <li>
              <Title className='five-steps' style={{ color: 'white' }} level={3}>
                <StepOne width={'40px'} /> Regístrate para crear una cuenta gratuita en KIIEX.
              </Title>
            </li>
            <li>
              <Title className='five-steps' style={{ color: 'white'}} level={3}>
            ...
            <li>
            <a href='https://exchange.kiiex.io/signup'><Button className='boton-comienza-ahora4' style={{ color: '#0F4DCC', width: '315px', height: '50px', fontWeight: 'bold', fontSize: '18px', padding: '5px', marginTop:'20px' }}>
